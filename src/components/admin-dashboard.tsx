        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="overflow-x-auto mb-4 -mx-4 px-4">
            <TabsList className="w-full flex h-auto gap-0 bg-white shadow-sm rounded-lg p-1">
              <TabsTrigger value="overview" className="flex-1 min-w-0 data-[state=active]:bg-teal-600 data-[state=active]:text-white text-xs sm:text-sm">
                <LayoutDashboard className="w-4 h-4 mr-1" />
                <span className="hidden sm:inline">Overview</span>
              </TabsTrigger>
              <TabsTrigger value="students" className="flex-1 min-w-0 data-[state=active]:bg-teal-600 data-[state=active]:text-white text-xs sm:text-sm">
                <Users className="w-4 h-4 mr-1" />
                <span className="hidden sm:inline">Students</span>
              </TabsTrigger>
              <TabsTrigger value="teachers" className="flex-1 min-w-0 data-[state=active]:bg-teal-600 data-[state=active]:text-white text-xs sm:text-sm">
              ...
              <TabsTrigger value="reports" className="flex-1 min-w-0 data-[state=active]:bg-teal-600 data-[state=active]:text-white text-xs sm:text-sm">
